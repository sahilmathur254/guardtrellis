...
The optional [OpenAI](openai.md) and [Azure](azure_openai.md) examples default to HTTP mocks.
...
Guard's control. Live evidence for both paths is pending and must be recorded separately
from mock results.
