...
| [#8 One real provider integration](https://github.com/sahilmathur254/guardtrellis/issues/8) | [OpenAI callback example](docs/openai.md), optional SDK, and mocked boundary tests. Maintainer-approved live smoke evidence is still pending. |
