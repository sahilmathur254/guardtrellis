...
| [#8 One real provider integration](https://github.com/sahilmathur254/guardtrellis/issues/8) | [OpenAI](docs/openai.md) and [Azure](docs/azure_openai.md) callback examples, optional SDK, and mocked boundary tests in the `0.1.0a2` candidate. Maintainer-approved live smoke evidence is still pending. |
