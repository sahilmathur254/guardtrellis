...
| [#8 One real provider integration](https://github.com/sahilmathur254/guardtrellis/issues/8) | Optional provider setup, ordinary mocked tests, and an explicitly opted-in live smoke result. |
