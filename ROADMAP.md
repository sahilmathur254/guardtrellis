...
| [#8 One real provider integration](https://github.com/sahilmathur254/guardtrellis/issues/8) | [OpenAI](docs/openai.md), [Azure](docs/azure_openai.md), and [Gemini](docs/gemini.md) callback examples, optional SDKs, and mocked boundary tests in the `0.1.0a2` candidate. Maintainer-approved live smoke evidence is still pending. |
